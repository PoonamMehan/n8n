      ...
      >
        ...
        <div className="p-4 border-t border-white/5">
          <button
            ...
            className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-pink-700 bg-red-500/5 border border-red-500/10 hover:bg-red-500/15 hover:border-red-500/20 hover:shadow-[0_0_15px_rgba(239,68,68,0.15)] transition-all text-sm font-medium"
          >
